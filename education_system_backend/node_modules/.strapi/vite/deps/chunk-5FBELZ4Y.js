...
var getEERoutes$1 = () => window.strapi.isEE ? [
  {
    ...
    lazy: async () => {
      const { AuthResponse } = await import("./AuthResponse-CWs8VL81-WYB2SHXX.js");
      return {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.AUDIT_LOGS) ? [
    {
      path: "audit-logs",
      lazy: async () => {
        const { ProtectedListPage } = await import("./ListPage-CD6ZO-Wp-F5FE4KTN.js");
        return {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.SSO) ? [
    {
      path: "single-sign-on",
      lazy: async () => {
        const { ProtectedSSO } = await import("./SingleSignOnPage-B7OU11gd-ICYJAUKY.js");
        return {
...
var AuthPage = () => {
  ...
  const Login$1 = useEnterprise(
    Login,
    async () => (await import("./Login-wOwE4WT_-ROVG3RQR.js")).LoginEE
  );
  const forms = useEnterprise(
    FORMS,
    async () => (await import("./constants-CV2faKSp-LYR4UM5I.js")).FORMS,
    {
...
var ROUTES_CE = [
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-BX6bIW1R-WQRF4ULG.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-D_fsEi_M-TAQCRIJD.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-tM4j7ixi-HZP5P66V.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-6AqXEX4y-FRR4YEGB.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-DKw8vquT-NE7P26PV.js");
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-DfdEecPk-YGQP3WPP.js");
      return {
        Component: ProtectedCreatePage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-DmCwq9lg-5AK6X6M3.js").then((n) => n.b);
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-w3LcIP0T-KULHOY2X.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-Df-gIOv9-IMRQQRHG.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-DuIhzj5r-WBZGZ2HU.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditViewPage-WRs6SDk3-ZXLMMNMT.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-Cj52m1Cx-C3XNEUG7.js");
      return {
        Component: ProtectedCreateView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-fOGcorFr-PRLAJKWU.js");
      return {
        Component: ProtectedListView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditView-F6qKlUJj-JCSBVERL.js");
      return {
        Component: ProtectedEditView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedInstalledPlugins } = await import("./InstalledPlugins-Chyea6Jt-7BRMLIXP.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseAuditLogs } = await import("./PurchaseAuditLogs-C3Umrg-5-O2EXFH5K.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseSingleSignOn } = await import("./PurchaseSingleSignOn-m3wEJIYm-SQ5TSWHH.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseContentHistory } = await import("./PurchaseContentHistory-BuIZGUim-TIYFVUP7.js");
      return {
...
var getImmutableRoutes = () => [
  {
    path: "usecase",
    lazy: async () => {
      const { PrivateUseCasePage } = await import("./UseCasePage-DFRtsARG-OSGQGL5L.js");
      return {
...
var getInitialRoutes = () => [
  {
    index: true,
    lazy: async () => {
      const { HomePage } = await import("./HomePage-idSom5Sg-GK7AEQ7Z.js");
      return {
        Component: HomePage
      };
    }
  },
  {
    path: "me",
    lazy: async () => {
      const { ProfilePage } = await import("./ProfilePage-DuSEvyq3-O7QQYSLR.js");
      return {
  ...
  },
  {
    path: "marketplace",
    lazy: async () => {
      const { ProtectedMarketplacePage } = await import("./MarketplacePage-ChPIl3Lm-ZGNPX2Z2.js");
      return {
  ...
  },
  {
    path: "settings/*",
    lazy: async () => {
      const { Layout } = await import("./Layout-TkS64Yl1-M7Y6VX64.js");
      return {
        Component: Layout
      };
    },
    children: [
      {
        ...
        lazy: async () => {
          const { ApplicationInfoPage } = await import("./ApplicationInfoPage-DGet0m1z-ACIPKDQI.js");
          return {
    ...
    const routes = [
      {
        ...
        children: [
          ...getImmutableRoutes(),
          {
            path: "/*",
            lazy: async () => {
              const { PrivateAdminLayout } = await import("./AuthenticatedLayout-CERzLY03-R5RROARZ.js");
              return {
  ...
  async loadAdminTrads() {
    const adminLocales = await Promise.all(
      this.configurations.locales.map(async (locale) => {
        try {
          const { default: data } = await __variableDynamicImportRuntimeHelper(Object.assign({ "./translations/en-GB.js": () => import("./en-GB-Ceyy7cF8-GIB6WSAS.js") }), `./translations/${locale}.js`, 3);
          return { data, locale };
        } catch {
          try {
            const { default: data } = await __variableDynamicImportRuntimeHelper(Object.assign({ "./translations/ar.json": () => import("./ar-7vbwrPth-TV7YEATV.js"), "./translations/ca.json": () => import("./ca-f06Q0InB-D327QKRC.js"), "./translations/cs.json": () => import("./cs-DrRkodPD-MENYAKR4.js"), "./translations/de.json": () => import("./de-D0NA2abW-ZA62DURN.js"), "./translations/dk.json": () => import("./dk-Cv0jDfcZ-VYR7ZIA5.js"), "./translations/en.json": () => import("./en-DOZzjg_v-HAXXS6QA.js"), "./translations/es.json": () => import("./es-XEfESBGO-AVPKLGWW.js"), "./translations/eu.json": () => import("./eu-CDMMTSys-AXFAEZMY.js"), "./translations/fr.json": () => import("./fr-CndUnB7j-EGV3BVZQ.js"), "./translations/gu.json": () => import("./gu-CSS25C49-JFXNNYV7.js"), "./translations/he.json": () => import("./he-C3w9omDw-LJNCZK3H.js"), "./translations/hi.json": () => import("./hi-DW2CutdA-M74LBDHI.js"), "./translations/hu.json": () => import("./hu-DaDd6FHR-LFHXYDW4.js"), "./translations/id.json": () => import("./id-cH3Ovozx-36G6TIT4.js"), "./translations/it.json": () => import("./it-T1rZP3NX-2EAZBUNI.js"), "./translations/ja.json": () => import("./ja-Cc9Dg_QK-LCHL7P5D.js"), "./translations/ko.json": () => import("./ko-D1e-SMHS-MKIZYUQM.js"), "./translations/ml.json": () => import("./ml-FLft_QIc-WYHZKT25.js"), "./translations/ms.json": () => import("./ms-eMDSLvhl-6VD2ULRY.js"), "./translations/nl.json": () => import("./nl-CubaFTJw-EZ2V6BBE.js"), "./translations/no.json": () => import("./no-9TbSG07o-KJMJH7UM.js"), "./translations/pl.json": () => import("./pl-B0hZgHvQ-AS2MQCM6.js"), "./translations/pt-BR.json": () => import("./pt-BR-BDpWvCrQ-GDN3FATO.js"), "./translations/pt.json": () => import("./pt-8dwKSOn3-KWXAX452.js"), "./translations/ru.json": () => import("./ru-C34i9wJx-VOJHG7CG.js"), "./translations/sa.json": () => import("./sa-CHD-r_h--KQ363U7Z.js"), "./translations/sk.json": () => import("./sk-DQ2qpsG2-LG36IYHY.js"), "./translations/sv.json": () => import("./sv-D0vPVUAT-5WXEC5MZ.js"), "./translations/th.json": () => import("./th-BG3IOCqV-HMPE7JUH.js"), "./translations/tr.json": () => import("./tr-Dq45DRRZ-RQD3M56B.js"), "./translations/uk.json": () => import("./uk-Ud9QNfkB-CV5DDSCM.js"), "./translations/vi.json": () => import("./vi-CGrr4ioy-YURZ7X56.js"), "./translations/zh-Hans.json": () => import("./zh-Hans-C44LvcXE-OXQD67L4.js"), "./translations/zh.json": () => import("./zh-LqPg8hbL-3YEKPJD5.js") }), `./translations/${locale}.json`, 3);
            return { data, locale };
          } catch {
...
//# sourceMappingURL=chunk-5FBELZ4Y.js.map
